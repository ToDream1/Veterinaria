    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('recepcionista/usuarios') ?>">
                        <i class="fas fa-users me-1"></i>Gestión de Usuarios
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('recepcionista/mascotas') ?>">
                        <i class="fas fa-dog me-1"></i>Gestionar Mascotas
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('recepcionista/citas') ?>">
