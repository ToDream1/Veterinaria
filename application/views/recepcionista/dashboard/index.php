<div class="container mt-4">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body">
                    <h1 class="mb-3">Panel Recepcionista</h1>
        ...
        <div class="col-md-4 mb-3">
            <div class="card bg-primary text-white h-100">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a href="<?= base_url('recepcionista/usuarios') ?>" class="text-white">Ver detalles</a>
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-md-3 mb-3">
                            <a href="<?= base_url('recepcionista/usuarios/crear') ?>" class="card text-center p-3 text-decoration-none btn-hover-effect text-primary">
                                <div class="mb-2">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="<?= base_url('recepcionista/mascotas/crear') ?>" class="card text-center p-3 text-decoration-none btn-hover-effect text-success">
                                <div class="mb-2">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="<?= base_url('recepcionista/citas/crear') ?>" class="card text-center p-3 text-decoration-none btn-hover-effect text-info">
                                <div class="mb-2">
