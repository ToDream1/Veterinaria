...
// $config['index_page'] = ''; // Cambiar de 'index.php' a ''
// $config['index_page'] = 'index.php';
...
|
*/
// Busca esta línea y asegúrate de que esté configurada como TRUE
...
$config['sess_save_path'] = BASEPATH . 'cache/sessions/'; // Cambia esto a una ruta válida
